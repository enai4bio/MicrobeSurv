# MVPool code is from this github project:
# https://github.com/cszhangzhen/MVPool
...
class MVPool(nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr, batch=None):
        ...
        if self.sl is False:
            return x, induced_edge_index, induced_edge_attr, batch, perm, score[perm]
        ...
        return x, new_edge_index, new_edge_attr, batch, perm, score[perm]
